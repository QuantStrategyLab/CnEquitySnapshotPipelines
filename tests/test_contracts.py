...
def test_contract_surface_includes_strategy_and_index_membership():
    ...
    assert CN_CHINEXT_GROWTH_MOMENTUM_QUALITY_SNAPSHOT_PROFILE in profiles
    ...
    assert chinext.contract_version == "cn_chinext_growth_momentum_quality_snapshot.factor_snapshot.v1"
    assert chinext.manifest_required_by_runtime is False
